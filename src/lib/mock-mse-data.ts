...
export const MOCK_MSE_DATA: MockMseData = {
  ...
  stockAmount: [
    { symbol: "KHAN", name: "Хаан банк ХК", code: 563, logoUrl: "", amountMnt: 262371826, changePct: 1.43, changeAbs: 19.0, direction: "up" },
    { symbol: "APU", name: "АПУ ХК", code: 12, logoUrl: "", amountMnt: 198450000, changePct: 0.1, changeAbs: 0.95, direction: "up" },
    { symbol: "TDB", name: "Худалдаа Хөгжлийн банк ХК", code: 880, logoUrl: "", amountMnt: 152800000, changePct: 0.0, changeAbs: 0.0, direction: "flat" },
  ],
  stockUp: [
  ...
  top20List: [
    ...
    { row: 7, symbol: "SUU", name: "Сүү ХК", code: 717 },
    { row: 8, symbol: "TDB", name: "Худалдаа Хөгжлийн банк ХК", code: 880 },
    { row: 9, symbol: "TTL", name: "Таван толгой ХК", code: 783 },
